...
describe('guitar', () => {
  describe('getFretboardPosition()', () => {
    ...
    it('get fret between 11 and 13', () => {
      ...
      expect(() => getFretboardPosition('E/5', 11, 13)).toThrowError(
        new Error('Could not place note on guitar fretboard')
      );
  ...
  describe('getFret', () => {
    ...
    it('should throw', () => {
      expect(() => getFret('Eb/2', 6)).toThrowError(new Error('Invalid fret'));
      expect(() => getFret('G#/5', 5)).toThrowError(new Error('Invalid fret'));
      expect(() => getFret('F/2', 2)).toThrowError(new Error('Invalid fret'));
      expect(() => getFret('F/6', 1)).toThrowError(new Error('Invalid fret'));
    });
  });
  ...
  describe('getNote', () => {
    ...
    it('should throw', () => {
      expect(() => getNote(-1, 2)).toThrowError(new Error('Invalid note'));
      expect(() => getNote(25, 5)).toThrowError(new Error('Invalid note'));
      expect(() => getNote(4, -1)).toThrowError(new Error('Invalid note'));
      expect(() => getNote(4, 7)).toThrowError(new Error('Invalid note'));
    });
  });
